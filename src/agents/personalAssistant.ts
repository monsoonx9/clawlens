...
export const SKILL_INVOCATION_KEYWORDS: Record<string, string[]> = {
  portfolio: ["portfolio", "holdings", "assets", "my tokens", "positions", "pnl", "profit", "loss"],
  price: ["price", "cost", "value", "worth", "trading at", "trading for"],
  analysis: ["analyze", "analysis", "technical", "indicators", "chart", "pattern"],
  audit: ["audit", "security", "risk", "honeypot", "rug", "safe", "scam"],
  whale: ["whale", "smart money", "large holder", "top trader", "insider"],
  market: ["market", "trend", "bull", "bear", "sentiment", "fear", "greed"],
  futures: ["futures", "leverage", "funding", "open interest", "oi", "long", "short"],
  news: ["news", "alert", "announcement", "update", "breaking"],
  education: ["explain", "what is", "how does", "learn", "beginner", "tutorial"],
  trading: ["trade", "buy", "sell", "order", "entry", "exit", "stop loss"],
};
